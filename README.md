...
A working port to Apple's new Swift language.
...
You will need atleast Xcode 7 to run the project. Run it in the simulator or on an actual device.
...
License
-------
(c) 2017-2015 Akshay Rawal. Released under the terms of the MIT license.
